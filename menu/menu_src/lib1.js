...
class GameManage
{
	...
	constructor()
	{
        ...
        this.bgm = new Audio('../menu_music/battle1.mp3');
	...
	showWaveImage()
	{
		ImageView.innerHTML += '<img id="wave" src="../menu_img/wave.png" style="position:absolute; left:250px; bottom:50px">';
		// wave.pngを隠す
		document.getElementById("wave").style.display = "none";
	}
	...
	showEffectImage()
	{
		ImageView.innerHTML += '<img id="effect1" src="../menu_img/effect1.png" style="position:absolute; left:350px; bottom:50px">';
		// effct1.pngを隠す
		document.getElementById("effect1").style.display = "none";
	}
		...
		for(let c in characters) {
			if(characters[c].hp <= 0 && characters[c].liveFlag === true) {
				...
				if(characters[c].type === "enemy") {
					...
					ImageView.innerHTML += '<img id="enemyImage" src="../menu_img/maguro.png" style="position:absolute; left:350px; bottom:50px">';
					//ImageView.innerHTML += '<img id="enemyImage" src="../menu_img/gyuniku.png" style="position:absolute; left:350px; bottom:50px">';
				}
			}
		}
	}
