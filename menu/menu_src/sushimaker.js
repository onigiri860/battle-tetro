        ...
        const blockImages = [];
        const imagePaths = [
        '../menu_img/maguro_sashimi1.png',
        '../menu_img/maguro_sashimi2.png',
        '../menu_img/maguro_sashimi3.png',
        '../menu_img/maguro_sashimi4.png'
        ];
        ...
        // 画像パスを配列に格納
        const sushiRiceImages = ['../menu_img/shari1_1.png', '../menu_img/shari1_2.png'];
        ...
        function showImage() {
            ...
            img.onload = function() {
                // 画像が読み込まれたら描画
                context.drawImage(img, BLOCK_SIZE*FIELD_COL/2, BLOCK_SIZE*FIELD_ROW/2, BLOCK_SIZE*3, BLOCK_SIZE*3);
            };
            // シャリにネタが乗ったとき
            if (Good == 1){
                img.src = '../menu_img/sushi_nigiri_maguro.png'; // 表示する画像のパス
                console.log("showImage");
            } 
            // シャリにネタが乗らなかったとき
            else {
                img.src = '../menu_img/shari1.png'; // 表示する画像のパス
